			...
			if(fileContent && window.FileReader) {
				...
				reader.onload = function(e) {
					...
					for(var i = 0; i < length; i++) {
						...
						obj.Repdate != undefined ? obj.Repdate = Core.that.Date_format_finder(obj.Repdate) : obj.Repdate = "";
						obj.Compd != undefined ? obj.Compd = Core.that.Date_format_finder(obj.Compd) : obj.Compd = "";
						obj.Rcompd != undefined ? obj.Rcompd = Core.that.Date_format_finder(obj.Rcompd) : obj.Rcompd = "";
